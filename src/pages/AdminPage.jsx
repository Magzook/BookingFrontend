      ...
      {showForm && (
        <form onSubmit={handleCreate} className={styles.resourceForm}>
          ...
          <div className={styles.formActions}>
            <button type="submit" className={styles.saveBtnSmall} disabled={uploading}>Создать</button>
              ...
              <div key={r.id} className={styles.resourceRow}>
                {editId === r.id
                  ? <form onSubmit={handleSaveEdit} className={styles.editResourceForm}>
                      ...
                      <div className={styles.formActions}>
                        <button type="submit" className={styles.saveBtnSmall} disabled={uploading}>Сохранить</button>
