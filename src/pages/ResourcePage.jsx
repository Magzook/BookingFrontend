...
function BookingCalendar({ workingDays, selected, onSelect }) {
...
function BookingForm({ resource, workingDays, onBooked }) {
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.bookForm}>
      <p className={styles.bLabel}>Дата</p>
      <BookingCalendar workingDays={workingDays} selected={day} onSelect={setDay} />
